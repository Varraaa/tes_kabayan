                    ...
                    @forelse($transaksi as $t)
                        <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600/50">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap">
                                <div class="font-semibold text-gray-900 dark:text-white">{{ date('d/m/Y', strtotime($t->tanggal)) }}</div>
                                <div class="text-[11px] text-gray-400 font-mono">{{ $t->created_at ? $t->created_at->format('H:i') : date('H:i', strtotime($t->tanggal)) }} WIB</div>
                            </td>
