                                ...
                                <div id="modal-detail-{{ $t->id }}" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative w-full max-w-2xl max-h-full text-left">
                                        <div
                                            ...
                                            <!-- Footer Modal -->
                                            <div
                                                class="flex items-center justify-between p-4 border-t border-gray-200 rounded-b dark:border-gray-700">
                                                @if($t->jenis === 'jual')
                                                    <a href="{{ route('transaksi.cetak', $t->id) }}" target="_blank"
                                                       class="text-white bg-emerald-600 hover:bg-emerald-700 focus:ring-4 focus:outline-none focus:ring-emerald-300 rounded-lg text-xs font-medium px-4 py-2 flex items-center gap-1.5 transition">
