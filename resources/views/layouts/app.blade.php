                ...
                @if (auth()->user()->role === 'admin')
                    ...
                    <li>
                        <a href="{{ route('laporan.penjualan') }}"
                            class="flex items-center p-2 rounded-lg {{ request()->routeIs('laporan.penjualan*') ? 'bg-blue-50 text-blue-600 dark:bg-gray-700 dark:text-blue-400 font-semibold' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }} group">
                            <svg class="w-5 h-5 text-gray-500 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('laporan.index') }}"
                            class="flex items-center p-2 rounded-lg {{ request()->routeIs('laporan.index') || request()->is('laporan') ? 'bg-blue-50 text-blue-600 dark:bg-gray-700 dark:text-blue-400 font-semibold' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }} group">
                            <svg class="w-5 h-5 text-gray-500 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <span class="ms-3">Laporan Mutasi Stok</span>
                        </a>
                    </li>
                @endif
            </ul>
