...
@section('header', 'Master Lokasi Gudang')
    ...
    <div
        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            <div class="w-full md:w-1/2">
                <h2 class="text-lg font-bold text-gray-900 dark:text-white">Daftar Lokasi & Cabang Gudang</h2>
                <p class="text-xs text-gray-500 dark:text-gray-400">Kelola titik penyimpanan fisik barang dan status
                    operasionalnya</p>
            </div>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3">Nama Gudang / Cabang</th>
                        <th scope="col" class="px-4 py-3">Alamat / Lokasi</th>
                ...
                <tbody>
                    @forelse($gudang as $index => $item)
                        <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <td class="px-4 py-3 font-semibold">{{ $gudang->firstItem() + $index }}</td>
                            <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">{{ $item->nama_gudang }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-4 py-6 text-center text-gray-400">Belum ada data gudang.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
